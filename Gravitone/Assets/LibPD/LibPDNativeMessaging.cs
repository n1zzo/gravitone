...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
		...
		[DllImport("__Internal", EntryPoint="libpd_set_printhook")]
		private static extern void set_printhook(LibPDPrintHook hook);

		[DllImport("__Internal", EntryPoint="libpd_set_banghook")]
		private static extern  void set_banghook(LibPDBangHook hook) ;

		[DllImport("__Internal", EntryPoint="libpd_set_floathook")]
		private static extern  void set_floathook(LibPDFloatHook hook) ;

		[DllImport("__Internal", EntryPoint="libpd_set_symbolhook")]
		private static extern  void set_symbolhook(LibPDSymbolHook hook) ;

		[DllImport("__Internal", EntryPoint="libpd_set_listhook")]
		private static extern  void set_listhook(LibPDListHook hook) ;

		[DllImport("__Internal", EntryPoint="libpd_set_messagehook")]
		...
		[DllImport("__Internal", EntryPoint="libpd_atom_is_float")]
		private static extern int atom_is_float(IntPtr a) ;

		[DllImport("__Internal", EntryPoint="libpd_atom_is_symbol")]
		private static extern int atom_is_symbol(IntPtr a) ;

		[DllImport("__Internal", EntryPoint="libpd_atom_get_float")]
		private static extern float atom_get_float(IntPtr a) ;

		[DllImport("__Internal", EntryPoint="libpd_atom_get_symbol")]
		private static extern IntPtr atom_get_symbol(IntPtr a);

		[DllImport("__Internal", EntryPoint="libpd_next_atom")]
		...
		[DllImport("__Internal", EntryPoint="libpd_bind")]
		...
		[DllImport("__Internal", EntryPoint="libpd_unbind")]
		...
		[DllImport("__Internal", EntryPoint="libpd_bang")]
		...
		[DllImport("__Internal", EntryPoint="libpd_float")]
		...
		[DllImport("__Internal", EntryPoint="libpd_symbol")]
		...
		[DllImport("__Internal", EntryPoint="libpd_start_message")]
		private static extern  int start_message(int max_length) ;

		[DllImport("__Internal", EntryPoint="libpd_finish_message")]
		...
		[DllImport("__Internal", EntryPoint="libpd_finish_list")]
		...
		[DllImport("__Internal", EntryPoint="libpd_add_float")]
		private static extern  void add_float(float x) ;

		[DllImport("__Internal", EntryPoint="libpd_add_symbol")]
